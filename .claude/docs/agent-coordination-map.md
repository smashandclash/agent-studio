...
```
  ...
  Engine Specialists (use the SET matching your engine):
    ...
    web-specialist     -- Web game lead: browser runtime, Three.js, TypeScript architecture
      threejs-specialist            -- Rendering: scene graph, materials, post-processing, performance
      typescript-webgame-specialist -- Architecture: game loop, typed state/input systems, tooling
```
