...
| `web-specialist` | Web (Three.js + TypeScript) | Sonnet | Browser game architecture, runtime constraints, render and performance strategy |
...
### Web Game Sub-Specialists

| Agent | Subsystem | Model | When to Use |
| ---- | ---- | ---- | ---- |
| `threejs-specialist` | Three.js Rendering | Sonnet | Scene graph design, materials, post-processing, draw call and GPU optimization |
| `typescript-webgame-specialist` | TypeScript Architecture | Sonnet | Typed game loop architecture, state/input systems, web game tooling |
