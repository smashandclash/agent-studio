...
For this fork, keep your Agent Studio custom files and merge structural
updates from the upstream template where relevant.
...
git remote add template https://github.com/smashandclash/agent-studio.git
