# Agent Studio -- Complete Workflow Guide

> **How to go from zero to a shipped game using the Agent Architecture.**
>
> This guide walks you through every phase of game development using the
> specialized agent system, slash commands, and automated hooks. It assumes you
...
Run `/setup-engine` in your agent workflow. This is the single most important
...
Start a new session. You should see output from the
`session-start.sh` hook:

```
=== Agent Studio -- Session Context ===
Branch: main
Recent commits:
...
| Web game architecture help | `web-specialist` | 3 |
| Three.js rendering help | `threejs-specialist` | 3 |
| TypeScript web game help | `typescript-webgame-specialist` | 3 |
...
| **Implementation** | `/code-review`, `/prototype`, `/tech-debt`, `/team-web` |
| **Investigation** | `/investigate` |
| **Testing** | `/balance-check`, `/playtest-report`, `/perf-profile`, `/qa-web` |
| **Safety** | `/careful`, `/freeze`, `/guard`, `/unfreeze` |
| **Assets** | `/asset-audit`, `/localize` |
| **Release** | `/release-checklist`, `/launch-checklist`, `/changelog`, `/patch-notes`, `/hotfix`, `/ship-release`, `/document-release` |
| **Production** | `/milestone-review`, `/onboard` |
| **Reflection** | `/retrospective`, `/retro-weekly` |
